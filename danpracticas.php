                    ...
                    <tr>
                        ...
                        <td>
                            <select name="txtLista">
                                ...
                                <option value="3" <?php echo $sel3 ==4?'selected' : '';?>>Función abs</option>
                                <option value="4" <?php echo $sel ==4 ?'selected' : '';?>>Función ceil</option>
                                <option value="5" <?php echo $sel ==5 ?'selected' : ''; ?>>Función getrandmax</option>
                                <option value="6" <?php echo $sel ==6 ?'selected' : ''; ?>>Función max</option>
                                <option value="7" <?php echo $sel7 == 7? 'selected' : '';?>>Función  min</option>
                                <option value="8" <?php echo $sel ==8?'selected' : '';?>>Función mt_rand</option>
                                <option value="9" <?php echo $sel9 == 9? 'selected' : '';?>>Función pi</option>
                                <option value="10" <?php echo $sel10 == 10? 'selected' : '';?>>Función pow</option>
                                <option value="11" <?php echo $sel11 == 11? 'selected' : '';?>>Función round</option>
                                <option value="12" <?php echo $sel12 == 12? 'selected' : '';?>>Función sqrt</option>
